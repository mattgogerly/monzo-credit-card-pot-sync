...
def test_core_flow_successful_no_change_required(mocker, test_client, requests_mock, seed_data):
    ...
    requests_mock.get("https://api.monzo.com/accounts", json={"accounts": [{"id": "acc_id"}]})
    requests_mock.get("https://api.monzo.com/balance?account_id=acc_id", json={"balance": 100})
...
def test_core_flow_successful_deposit(mocker, test_client, requests_mock, seed_data):
    ...
    requests_mock.get("https://api.monzo.com/accounts", json={"accounts": [{"id": "acc_id"}]})
    requests_mock.get("https://api.monzo.com/balance?account_id=acc_id", json={"balance": 100000})
...
def test_core_flow_insufficient_account_balance(mocker, test_client, requests_mock, seed_data):
    ...
    requests_mock.get("https://api.monzo.com/accounts", json={"accounts": [{"id": "acc_id"}]})
    requests_mock.get("https://api.monzo.com/balance?account_id=acc_id", json={"balance": 50000})
